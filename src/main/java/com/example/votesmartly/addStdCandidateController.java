...
public class addStdCandidateController implements Initializable {
    ...
    public void addCandidate()
    {
        ...
        try {
            ...
            PreparedStatement updatePost =
                    conn.prepareStatement("UPDATE student SET total_candidates = total_candidates + 1 WHERE posts=?");
            ...
            postBox.getSelectionModel().clearSelection();
    ...
    public void addCandidatesFromFile()
    {
        ...
        try {
            ...
            if(duplicateSYM>0)
                new Alert(Alert.AlertType.WARNING,duplicateSYM+" symbols ignored (Duplicate)").showAndWait();
